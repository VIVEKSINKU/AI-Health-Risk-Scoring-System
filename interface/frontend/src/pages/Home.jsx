      ...
      <section id="features" className="bg-cream text-ink py-28 px-8 reveal opacity-0 translate-y-[20px] transition-all duration-600">
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(280px,1fr))] gap-6">
            <FeatureCard title="ML Disease Prediction" desc="Our ensemble model analyses over 80 biomarkers to predict conditions like diabetes, hypertension, and cardiac risk with clinical-grade accuracy." color="#00b89c" bg="rgba(0,184,156,0.1)" />
            <FeatureCard title="Smart Report OCR" desc="Upload blood tests, MRI scans, or X-rays. Our OCR engine extracts values and integrates them automatically into your risk profile." color="#3b82f6" bg="rgba(59,130,246,0.1)" />
            <FeatureCard title="Risk Score Dashboard" desc="A clear 0–100 risk score with visual breakdowns by condition, biomarker, and symptom — so you understand exactly what's driving your result." color="#f59e0b" bg="rgba(245,158,11,0.1)" />
            <FeatureCard title="Personalised Recommendations" desc="From lifestyle changes to specialist referrals, MedAI gives you an actionable plan tailored to your exact findings and risk level." color="#8b5cf6" bg="rgba(139,92,246,0.1)" />
            <FeatureCard title="Privacy First" desc="End-to-end encrypted. Your data is never sold or shared. HIPAA-compliant infrastructure with zero third-party data exposure." color="#ef4444" bg="rgba(239,68,68,0.1)" />
            <FeatureCard title="Real-Time Analysis" desc="Results in under 2 seconds. No waiting rooms, no appointments. Get your full health report the moment you submit your data." color="#10b981" bg="rgba(16,185,129,0.1)" />
          </div>
        </div>
      </section>
